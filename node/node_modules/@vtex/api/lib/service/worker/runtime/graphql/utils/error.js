    ...
    if (formattedError.originalError) {
        ...
        if (!formattedError.extensions.exception) {
            formattedError.extensions.exception = {
                ...
                ...ramda_1.omit(error_1.SENSITIVE_EXCEPTION_FIELDS, formattedError.originalError),
                sensitive: ramda_1.pick(error_1.SENSITIVE_EXCEPTION_FIELDS, formattedError.originalError),
            };
        }
        else {
            ...
            const extendedException = {
                message: formattedError.originalError.message,
                name: formattedError.originalError.name,
                ...ramda_1.omit(error_1.SENSITIVE_EXCEPTION_FIELDS, mergedException),
                sensitive: ramda_1.pick(error_1.SENSITIVE_EXCEPTION_FIELDS, mergedException),
            };
